...
myKeys =
    ...
    , ((myModMask,                 xK_Down),  prevWS)
    , ((myModMask,                 xK_u),     prevWS)
    , ((myModMask,                 xK_Up),    nextWS)
    , ((myModMask,                 xK_i),     nextWS)
    , ((myModMask .|. controlMask, xK_Down),  shiftToPrev)
    , ((myModMask .|. controlMask, xK_u),     shiftToPrev)
    , ((myModMask .|. controlMask, xK_Up),    shiftToNext)
    , ((myModMask .|. controlMask, xK_i),     shiftToNext)
    , ((myModMask .|. shiftMask,   xK_Down),  shiftToPrev >> prevWS)
    , ((myModMask .|. shiftMask,   xK_u),     shiftToPrev >> prevWS)
    , ((myModMask .|. shiftMask,   xK_Up),    shiftToNext >> nextWS)
